...
export const SEO_COPY = {
  home: {
    ar: {
      title: "سفرية | حجز تذاكر الطيران والباصات والرحلات الخاصة",
      description:
        "سفرية منصة متكاملة لحجز رحلات الطيران وتذاكر الباصات والرحلات الخاصة بأسعار واضحة ودفع آمن، مع تأكيد فوري للحجز وخدمة عملاء على مدار الساعة.",
    },
    en: {
  ...
  aboutUs: {
    ar: {
      ...
      description:
        "تعرّف على منصة سفرية ورؤيتنا في تسهيل حجز رحلات الطيران والباصات والرحلات الخاصة، وعلى شركات النقل المعتمدة التي نعمل معها لتوفير تجربة سفر موثوقة.",
    },
    en: {
  ...
  discover: {
    ar: {
      ...
      description:
        "ابحث في رحلات الطيران والباصات والرحلات الخاصة المتاحة، وقارن الأوقات والأسعار وشركات النقل، ثم أكمل حجزك في خطوات قليلة.",
    },
    en: {
  ...
  discoverBus: {
    ar: {
      title: "حجز تذاكر الباصات بين المدن",
      description:
        "احجز تذاكر الباصات بين المدن واختر مقعدك على الخريطة، مع مواعيد رحلات واضحة وأسعار مناسبة من شركات النقل المعتمدة على سفرية.",
    },
    en: {
